        ...
        <form name="studForm" ng-submit="save(studForm)" novalidate> <!-- novalidate prevents HTML5 validation -->
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <div ng-show="studForm.$submitted || studForm.firstName.$touched"><span ng-show="studForm.firstName.$error.required"
                                                                                            class="text-danger">First Name is Required.</span></div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <div ng-show="studForm.$submitted || studForm.lastName.$touched"><span ng-show="studForm.lastName.$error.required"
                                                                                           class="text-danger">Last Name is Required.</span></div>
